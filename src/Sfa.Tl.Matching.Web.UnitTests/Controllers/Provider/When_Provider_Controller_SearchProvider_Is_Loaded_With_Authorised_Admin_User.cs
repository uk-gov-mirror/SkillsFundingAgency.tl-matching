...
{
    public class When_Provider_Controller_SearchProvider_Is_Loaded_With_Authorised_Admin_User
    {
        private readonly IActionResult _result;

        public When_Provider_Controller_SearchProvider_Is_Loaded_With_Authorised_Admin_User()
        {
